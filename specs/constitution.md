...
4. **Bilingual UI, not bilingual NLP (yet).** EN/ES interface strings are required for the shell. Spanish (or other) linguistic models are roadmap work, not a silent claim in the current product.
